...
import org.moeaframework.core.operator.Integer.DifferentialEvolutionInteger;
import org.moeaframework.core.operator.Integer.DifferentialEvolutionInteger2;
import org.moeaframework.core.operator.Integer.DifferentialEvolutionInteger3;
import org.moeaframework.core.operator.Integer.DifferentialEvolutionInteger4;
import org.moeaframework.core.operator.Integer.PCXInteger;
import org.moeaframework.core.operator.Integer.PMInteger;
import org.moeaframework.core.operator.Integer.RandOpInteger;
import org.moeaframework.core.operator.Integer.SBXInteger;
import org.moeaframework.core.operator.Integer.SPXInteger;
import org.moeaframework.core.operator.Integer.UMInteger;
import org.moeaframework.core.operator.Integer.UNDXInteger;
	...
	public Variation getVariation(String name, Properties properties,
		...
		if (name.equalsIgnoreCase("sbx")) {
			...
			return new DifferentialEvolution(
					typedProperties.getDouble("de.crossoverRate", 0.5), 
		...
		}else if (name.equalsIgnoreCase("umIe")) {
			return new UMInteger(
					typedProperties.getDouble("umIe.rate", 
							1.0 / problem.getNumberOfVariables()));
		}else if (name.equalsIgnoreCase("sbxIe")) {
			return new SBXInteger(
					typedProperties.getDouble("sbxIe.rate", 1.0), 
					typedProperties.getDouble("sbxIe.distributionIndex", 20.0));
		}else if (name.equalsIgnoreCase("pmIe")) {
			return new PMInteger(
					typedProperties.getDouble("pmIe.rate", 
							1.0 / problem.getNumberOfVariables()), 
							typedProperties.getDouble("pmIe.distributionIndex", 20.0));
		} else if (name.equalsIgnoreCase("deIe")) {	
			return new DifferentialEvolutionInteger(
					typedProperties.getDouble("deIe.crossoverRate", 0.5), 
					typedProperties.getDouble("deIe.stepSize", 0.5));
		}else if (name.equalsIgnoreCase("deIe2")) {	
			return new DifferentialEvolutionInteger2(
					typedProperties.getDouble("deIe.crossoverRate", 0.5), 
					typedProperties.getDouble("deIe.stepSize", 0.5));
		}else if (name.equalsIgnoreCase("deIe3")) {	
			return new DifferentialEvolutionInteger3(
					typedProperties.getDouble("deIe.crossoverRate", 0.5), 
					typedProperties.getDouble("deIe.stepSize", 0.5),
					typedProperties.getDouble("deIe.stepSize", 0.5));
		}else if (name.equalsIgnoreCase("deIe4")) {	
			return new DifferentialEvolutionInteger4(
					typedProperties.getDouble("deIe.crossoverRate", 0.5), 
					typedProperties.getDouble("deIe.stepSize", 0.5),
					typedProperties.getDouble("deIe.stepSize", 0.5));
		}else if (name.equalsIgnoreCase("pcxIe")) {
			return new PCXInteger(
					(int)typedProperties.getDouble("pcxIe.parents", 3),
					(int)typedProperties.getDouble("pcxIe.offspring", 2), 
					typedProperties.getDouble("pcxIe.eta", 0.1), 
					typedProperties.getDouble("pcxIe.zeta", 0.1));
		} else if (name.equalsIgnoreCase("undxIe")) {
			return new UNDXInteger(
					(int)typedProperties.getDouble("undxIe.parents", 3),
					(int)typedProperties.getDouble("undxIe.offspring", 2), 
					typedProperties.getDouble("undxIe.zeta", 0.5), 
					typedProperties.getDouble("undxIe.eta", 0.35));
		}else if (name.equalsIgnoreCase("spxIe")) {
			return new SPXInteger(
					(int)typedProperties.getDouble("spxIe.parents", 10),
					(int)typedProperties.getDouble("spxIe.offspring", 2),
					typedProperties.getDouble("spxIe.epsilon", 3));
		}else if(name.equalsIgnoreCase("rmIe")){
			return new RandOpInteger();
		} else {
			return null;
		}
	}
