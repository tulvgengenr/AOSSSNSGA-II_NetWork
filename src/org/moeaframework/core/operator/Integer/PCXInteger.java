 ...
 * </ol>
 */
public class PCXInteger implements Variation,Serializable{
    private static final long serialVersionUID = -6166615862214221086L;
	 ...
	 *        operator
	 */
	public PCXInteger(int numberOfParents, int numberOfOffspring) {
	 ...
	 *        parents
	 */
	public PCXInteger(int numberOfParents, int numberOfOffspring, double eta,
			double zeta) {
    ...
    public String toString() {
        return "PCXInteger{" + "#Parents=" + numberOfParents + ", #Offspring=" + numberOfOffspring + ", eta=" + eta + ", zeta=" + zeta + '}';
    }
