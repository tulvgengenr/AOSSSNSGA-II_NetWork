 ...
 * </ol>
 */
public class DifferentialEvolutionInteger2 implements Variation,Serializable {
	 ...
	 */
	public DifferentialEvolutionInteger2(double CR, double F) {
		this.CR = CR;
		this.F = F;
    ...
    public String toString() {
        return "DifferentialEvolutionInteger{" + "CR=" + CR + ", F=" + F + '}';
    }
