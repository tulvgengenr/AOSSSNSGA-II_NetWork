 ...
 */
public class JObjectiveComparator implements Comparator {
   ...
   */
  public JObjectiveComparator(int nObj) {
    this.nObj = nObj;
    ascendingOrder_ = true;
  } // JObjectiveComparator

  public JObjectiveComparator(int nObj, boolean descendingOrder) {
    this.nObj = nObj;
    if (descendingOrder)
