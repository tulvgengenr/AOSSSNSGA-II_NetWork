 ...
 * Kalyanmoy Deb, Qingfu Zhang, Senior Member, and Qiang Zhang. 2015. 鈥淓fficient
 * Non-Domination Level Update Method for Steady-State Evolutionary
 * Multi-Objective Optimization.鈥� COIN Report Number 2015022
 *
 * @author nozomihitomi
 */
public class SteadyStateFastNonDominatedSorting extends FastNondominatedSorting {
    ...
    private int add(Solution individual, Population population) {
        ...
        HashMap<Integer, Integer> frontSize = new HashMap<Integer, Integer>();
