 ...
 * @author SEAK2
 */
public class AOSSSNSGAII extends SteadyStateNSGAII implements IHyperHeuristic {
    ...
    public AOSSSNSGAII(Problem problem, NondominatedSortingPopulation population,
            EpsilonBoxDominanceArchive archive, Selection selection,
            Initialization initialization, INextHeuristic heuristicSelector,
            ICreditAssignment creditDef,String file) {
    ...
    public void iterate() {
        ...
        if (creditDef.getInputType() == CreditFunctionInputType.OP) {
            ...
            try {
                ...
                Logger.getLogger(AOSSSNSGAII.class.getName()).log(Level.SEVERE, null, e);
            }
